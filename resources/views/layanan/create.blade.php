    ...
    <div class="col-lg-12">
        <div class="card card-outline-primary">
            <div class="card-body">
                ...
                @endif
                <form method="POST" enctype="multipart/form-data" action="{!! route('layanan.save') !!}" style="margin-top: 20px;">
                    {{ csrf_field() }}
                    <div class="form-body">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="checkbox checkbox-success">
                                            <input id="checkbox{{$syarat->id_persyaratan}}" type="checkbox" name="persyaratan[]" value="{{ $syarat->id_persyaratan }}">
                                            <label for="checkbox{{$syarat->id_persyaratan}}"> &nbsp; {{ $syarat->jenis_persyaratan }}</label>
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group has-danger">
                                    ...
                                    <input type="file" name="template" id="template" class="form-control form-control-danger" required accept=".docx">
                                    <!-- <small class="form-control-feedback"> This field has error. </small>  --></div>
                            </div>
                        </div>
                    </div>

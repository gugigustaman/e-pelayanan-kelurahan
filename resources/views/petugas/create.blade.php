...
<div class="row">
    <div class="col-lg-12">
        <div class="card card-outline-primary">
            <div class="card-body">
            	<h4 class="card-title">Tambah Petugas <a href="{!! route('petugas.index') !!}" class="btn btn-info pull-right"><i class="fa fa-arrow-left"></i> &nbsp; Kembali</a></h4>
                <form method="POST" action="{!! route('petugas.save') !!}" style="margin-top: 20px;">
                    {{ csrf_field() }}
                    <div class="form-body">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group has-danger">
                                    ...
                                    <input type="text" name="nama_petugas" id="nama_petugas" class="form-control form-control-danger" required>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group has-danger">
                                    ...
                                    <input type="text" id="jabatan" name="jabatan" class="form-control form-control-danger" required>
                                    <!-- <small class="form-control-feedback"> This field has error. </small>  --></div>
                            </div>
                            <!--/span-->
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <textarea name="alamat" rows="3" class="form-control" required style="height: auto !important"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
